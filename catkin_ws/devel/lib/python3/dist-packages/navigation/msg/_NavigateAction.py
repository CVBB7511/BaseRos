...
"""autogenerated by genpy from navigation/NavigateAction.msg. Do not edit."""
import codecs
import sys
...
class NavigateAction(genpy.Message):
  _md5sum = "69ac2c4486247a3f173cc01997363945"
  _type = "navigation/NavigateAction"
...
"""
  ...
  _slot_types = ['navigation/NavigateActionGoal','navigation/NavigateActionResult','navigation/NavigateActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = navigation.msg.NavigateActionGoal()
      if self.action_result is None:
        self.action_result = navigation.msg.NavigateActionResult()
      if self.action_feedback is None:
        self.action_feedback = navigation.msg.NavigateActionFeedback()
    else:
      self.action_goal = navigation.msg.NavigateActionGoal()
      self.action_result = navigation.msg.NavigateActionResult()
      self.action_feedback = navigation.msg.NavigateActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_7d3I().pack(_x.action_goal.goal.pos.position.x, _x.action_goal.goal.pos.position.y, _x.action_goal.goal.pos.position.z, _x.action_goal.goal.pos.orientation.x, _x.action_goal.goal.pos.orientation.y, _x.action_goal.goal.pos.orientation.z, _x.action_goal.goal.pos.orientation.w, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      buff.write(_get_struct_B().pack(_x))
      _x = self.action_feedback.feedback.cur_state
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_feedback.feedback.percentage,) = _get_struct_B().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_feedback.feedback.cur_state = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_feedback.feedback.cur_state = str[start:end]
      return self
