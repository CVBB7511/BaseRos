...
"""autogenerated by genpy from navigation/NavigateActionResult.msg. Do not edit."""
import codecs
import sys
...
class NavigateActionResult(genpy.Message):
  ...
  _type = "navigation/NavigateActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','navigation/NavigateResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = navigation.msg.NavigateResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = navigation.msg.NavigateResult()
