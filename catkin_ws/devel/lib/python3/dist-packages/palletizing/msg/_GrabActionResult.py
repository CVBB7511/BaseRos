...
"""autogenerated by genpy from palletizing/GrabActionResult.msg. Do not edit."""
import codecs
import sys
...
class GrabActionResult(genpy.Message):
  _md5sum = "1471476fb0fc7d1ce25819ffcafc3f6d"
  _type = "palletizing/GrabActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','palletizing/GrabResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GrabActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = palletizing.msg.GrabResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = palletizing.msg.GrabResult()
