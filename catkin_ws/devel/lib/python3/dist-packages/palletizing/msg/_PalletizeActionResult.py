...
"""autogenerated by genpy from palletizing/PalletizeActionResult.msg. Do not edit."""
import codecs
import sys
...
class PalletizeActionResult(genpy.Message):
  _md5sum = "1471476fb0fc7d1ce25819ffcafc3f6d"
  _type = "palletizing/PalletizeActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','palletizing/PalletizeResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PalletizeActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = palletizing.msg.PalletizeResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = palletizing.msg.PalletizeResult()
