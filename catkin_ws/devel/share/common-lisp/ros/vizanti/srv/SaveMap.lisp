...
(cl:defmethod cl:initialize-instance :after ((m <SaveMap-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SaveMap-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vizanti-srv:<SaveMap-request> is deprecated: use vizanti-srv:SaveMap-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <SaveMap-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SaveMap-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vizanti-srv:<SaveMap-response> is deprecated: use vizanti-srv:SaveMap-response instead.")))
