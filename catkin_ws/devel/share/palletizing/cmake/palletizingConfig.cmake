...
if("TRUE" STREQUAL "TRUE")
  set(palletizing_SOURCE_PREFIX /home/robot6/catkin_ws/src/palletizing)
  set(palletizing_DEVEL_PREFIX /home/robot6/catkin_ws/devel)
  ...
  set(palletizing_INSTALL_PREFIX /home/robot6/catkin_ws/install)
...
if(NOT "/home/robot6/catkin_ws/devel/include " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'zsj <23371527@buaa.edu.cn>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'palletizing' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot6/catkin_ws/src/palletizing/${idir}'.  ${_report}")
    endif()
...
set(depends "rospy;std_msgs;geometry_msgs;actionlib_msgs;message_runtime")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(palletizing_EXPORTED_TARGETS ${${palletizing_dep}_EXPORTED_TARGETS})
endforeach()
