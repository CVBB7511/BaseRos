...
class FieldCalibrationWizard:
    ...
    def _summary(self):
        ...
        print(
            ...
            "use_feature_override:=true feature_override:=%s rviz:=true"
            % (self.zone_file, self.feature_file),
            flush=True,
        )
...
def parse_args():
    ...
    parser.add_argument("--zone-plan", default="A:source:,B:drop:green,C:drop:blue")
    parser.add_argument("--cargo-types", default="green,blue")
    parser.add_argument("--table-height", type=float, default=0.78)
    ...
    parser.add_argument("--rgb-topic", default="/kinect2/qhd/image_color_rect")
    parser.add_argument("--depth-topic", default="/kinect2/qhd/image_depth_rect")
    parser.add_argument("--camera-info-topic", default="/kinect2/qhd/camera_info")
    parser.add_argument("--feature-min-area", type=int, default=1200)
    parser.add_argument("--feature-roi-x", type=float, default=0.35)
    parser.add_argument("--feature-roi-y", type=float, default=0.30)
    parser.add_argument("--feature-roi-width", type=float, default=0.30)
    parser.add_argument("--feature-roi-height", type=float, default=0.35)
